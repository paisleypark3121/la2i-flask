...
code="""nt = Network()
nt.add_node("Velletri", label="Velletri")
nt.add_node("Italy", label="Italy")
nt.add_node("Metropolitan City of Rome", label="Metropolitan City of Rome")
nt.add_node("Lazio", label="Lazio")
nt.add_node("History", label="History")
nt.add_node("Roman Empire", label="Roman Empire")
nt.add_node("Roman Emperors", label="Roman Emperors")
nt.add_node("Cathedral of Saint Clement", label="Cathedral of Saint Clement")
nt.add_node("Wine Production", label="Wine Production")
nt.add_node("Festa dell'Uva e del Vino", label="Festa dell'Uva e del Vino")
nt.add_edge("Velletri", "Italy", label="is in")
nt.add_edge("Velletri", "Metropolitan City of Rome", label="is in")
nt.add_edge("Velletri", "Lazio", label="is in")
nt.add_edge("Velletri", "History", label="has")
nt.add_edge("History", "Roman Empire", label="era")
nt.add_edge("Roman Empire", "Roman Emperors", label="birthplace of")
nt.add_edge("History", "Cathedral of Saint Clement", label="site")
nt.add_edge("Velletri", "Wine Production", label="known for")
nt.add_edge("Velletri", "Festa dell'Uva e del Vino", label="hosts")
"""
...
def generateInteractiveMindMap(
    ...
    # Create a dictionary to store variables from exec
    local_vars = {}

    exec(code, globals(), local_vars)
    local_vars['nt'].toggle_physics(physics)
    
    # Return the network graph from local_vars
    return local_vars['nt']
    


def generateInteractiveMindMap_test(
    language,
    type,
    text,
    physics,
...
#     mm.add_node("Velletri", label="Velletri")
#     mm.add_node("Italy", label="Italy")
#     mm.add_node("Metropolitan City of Rome", label="Metropolitan City of Rome")
#     mm.add_node("Lazio", label="Lazio")
#     mm.add_node("History", label="History")
#     mm.add_node("Roman Empire", label="Roman Empire")
#     mm.add_node("Roman Emperors", label="Roman Emperors")
#     mm.add_node("Cathedral of Saint Clement", label="Cathedral of Saint Clement")
#     mm.add_node("Wine Production", label="Wine Production")
#     mm.add_node("Festa dell'Uva e del Vino", label="Festa dell'Uva e del Vino")

#     mm.add_edge("Velletri", "Italy", label="is in")
#     mm.add_edge("Velletri", "Metropolitan City of Rome", label="is in")
#     mm.add_edge("Velletri", "Lazio", label="is in")
#     mm.add_edge("Velletri", "History", label="has")
#     mm.add_edge("History", "Roman Empire", label="era")
#     mm.add_edge("Roman Empire", "Roman Emperors", label="birthplace of")
#     mm.add_edge("History", "Cathedral of Saint Clement", label="site")
#     mm.add_edge("Velletri", "Wine Production", label="known for")
#     mm.add_edge("Velletri", "Festa dell'Uva e del Vino", label="hosts")
...
#     font_size = 14
#     figure, ax = plt.subplots(figsize=(20, 15))
#     nx.draw(mm, pos, with_labels=True, font_weight='bold', node_size=list(node_sizes.values()), node_color="skyblue",
#             font_size=font_size, edge_color="gray", nodelist=list(mm.nodes()), ax=ax)
#     edge_labels = nx.get_edge_attributes(mm, 'label')
#     nx.draw_networkx_edge_labels(mm, pos, edge_labels=edge_labels, font_size=font_size, font_color='red', ax=ax)
